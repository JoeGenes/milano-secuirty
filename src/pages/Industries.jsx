    ...
    <div className="animate-fade-in">
      <section style={{ background: 'linear-gradient(135deg, #0A0B3D 0%, #151A66 100%)', color: '#FFF', padding: '4.5rem 0' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1.05fr 0.95fr', gap: '2rem', alignItems: 'center' }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: '18px', padding: '1.4rem', border: '1px solid rgba(255,255,255,0.14)' }}>
      ...
      <section style={{ padding: '4.5rem 0', backgroundColor: '#F3F5F7' }}>
        <div className="container">
          ...
          <div style={{ marginTop: '3rem', background: 'linear-gradient(135deg, #0A0B3D 0%, #151A66 100%)', color: '#FFF', borderRadius: '18px', padding: '2.5rem 2rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: '1.5rem', color: '#FFF', marginBottom: '0.8rem' }}>Need a solution for a specialized operation?</h3>
