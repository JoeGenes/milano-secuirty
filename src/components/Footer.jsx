...
export default function Footer({ setCurrentPage, lang }) {
  ...
  return (
    <footer style={{ backgroundColor: '#FFFFFF', color: '#0A0B3D', paddingTop: '4.5rem', borderTop: '2px solid #0A0B3D' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '3rem', marginBottom: '4rem' }}>
          ...
          <div>
            <div style={{ marginBottom: '1.2rem' }} onClick={() => handleNavigate('home')}>
            ...
            <div style={{ background: '#F8FAFC', borderRadius: '6px', padding: '1rem', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 'bold', color: '#0A0B3D', marginBottom: '0.4rem', display: 'flex', alignItems: 'center', gap: '0.4rem', textTransform: 'uppercase' }}>
          ...
          {/* Col 2: Our Services */}
          <div>
            <h4 style={{ color: '#0A0B3D', fontSize: '0.9rem', marginBottom: '1.2rem', fontFamily: 'Montserrat, sans-serif', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Our Services
            </h4>
              ...
              {[
                ...
                <li key={idx}>
                  <button 
                    ...
                    style={{ background: 'none', border: 'none', color: '#475569', cursor: 'pointer', textAlign: 'left', padding: 0, fontSize: '0.85rem', transition: '0.2s' }}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem', fontSize: '0.85rem', color: '#475569' }}>
      ...
      <div style={{ backgroundColor: '#F8FAFC', borderTop: '1px solid #E2E8F0', padding: '1.2rem 0', textAlign: 'center', fontSize: '0.78rem', color: '#64748B' }}>
        <div className="container">
